class BGLayer1 extends BGBaseLayer // Full Chernarus
{
    ...
    void BGCreateNewEvent()
    {
        ...
        if (location)
        {
            ...
            Print("[BattlegroundsV1] New Event: " + m_CurrentLocationName);
    ...
    override void SetTeleporterDestinations() 
    {
        ...
        {
            vector destination = GetRandomLocation().GetPosition();
    ...
    void InitLocations()
    {
        ...
        m_EventLocations.Insert(new BattlegroundsLocation("1270.706543 294.042450 11506.480469", "Ski Resort [B4-1]"));
        ...
        m_EventLocations.Insert(new BattlegroundsLocation("1165.598877 185.339996 7225.602051", "Myshkina Military [B9-7]"));
        ...
        m_EventLocations.Insert(new BattlegroundsLocation("10594.654297 34.160213 2526.907471", "Electro Chunch [K13-2]"));
